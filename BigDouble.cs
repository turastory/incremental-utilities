...
namespace BreakInfinity
{
    ...
    public static class BigDoubleExtensions
    {
        ...
        public static string ToStringWithSign(this BigDouble value, string format)
        {
            if (BigDouble.IsNaN(value))
                return "NaN";
            return value.Sign() > 0 ? $"+{value.ToString(format)}" : value.ToString(format);
        }
    ...
    public static class CustomBigDoubleExtensions
    {
